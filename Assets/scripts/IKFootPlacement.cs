    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        { // Only carry out the following code if there is an Animator set.
            ...
            if (Physics.Raycast(ray, out hit, DistanceToGround + 1f, layerMask))
            {
                ...
                if ((hit.transform.tag == "Ground") || (hit.transform.tag == "tri_up") || (hit.transform.tag == "tri_down") || (hit.transform.tag == "cube") || (hit.transform.tag == "cyl_up") || (hit.transform.tag == "cyl_down"))
                {
